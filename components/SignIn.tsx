...
export default function SignIn() {
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-gray-900 to-black text-white overflow-hidden flex items-center justify-center">
      {/* Background elements */}
      ...
      <Card className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-gray-300">
            Connect to KreateAI with your Google account
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
            variant="outline"
            size="lg"
            className="w-full bg-white text-black hover:bg-amber-400 transition-all duration-300 flex items-center justify-center gap-2 py-6"
